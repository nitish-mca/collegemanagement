<div class="courses index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('course_details'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($course['Teacher']['name'], array('controller' => 'teachers', 'action' => 'view', $course['Teacher']['id'])); ?>
		</td>
		<td><?php echo h($course['Course']['fee']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['status']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['created']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['modified']); ?>&nbsp;</td>
		<td><?php echo h($course['Course']['course_details']); ?>&nbsp;</td>
		<td class="actions">
